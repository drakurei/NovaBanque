export const images = {
  hero: {
    src: "https://images.unsplash.com/photo-1499678329028-101435549a4e?w=2400&q=85&auto=format&fit=crop",
    alt: "Coucher de soleil sur le Léman, vue depuis une villa moderne",
    blurDataURL:
      "data:image/jpeg;base64,",
  },
  manifesto: {
    src: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1600&q=85&auto=format&fit=crop",
    alt: "Intérieur architectural moderne, vue sur les Alpes",
  },
  inventaire: [
    {
      src: "https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=1000&q=85&auto=format&fit=crop",
      alt: "Carte bancaire métal noir mat",
    },
    {
      src: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=1000&q=85&auto=format&fit=crop",
      alt: "Graphique de performance financière",
    },
    {
      src: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=1000&q=85&auto=format&fit=crop",
  ...
  featured: {
    src: "https://images.unsplash.com/photo-1613553474179-e1eda3ea5734?w=2400&q=85&auto=format&fit=crop",
